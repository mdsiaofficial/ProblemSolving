...
int main() {
   ...
   //string number1 = "259058909701382810435441643464652692076";
   //string number2 = "75306452065121335498200664981021461578";
   string number1, number2;
   char x;
   cin >> number1 >> x >> number2;

   //cout << "Sum of two large numbers is " << addBigNumbers(number1, number2);
   cout << addBigNumbers(number1, number2) << endl;
